...
// import { School } from 'react-feather/dist/icons/school';
        ...
        >
          ...
          <div className="relative h-32 sm:h-40 md:h-48 bg-gradient-to-r from-indigo-500 to-purple-600">
            ...
            <motion.button
              ...
              className={`absolute top-4 right-4 sm:top-6 sm:right-6 flex items-center gap-2 px-4 py-2 sm:px-6 sm:py-3 rounded-xl ${isEditing ? 'bg-red-500 hover:bg-red-600' : 'bg-white text-indigo-600 hover:bg-indigo-50'
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start -mt-16 sm:-mt-20 md:-mt-24">
              ...
              <div className="mt-4 md:mt-0 md:ml-6 lg:ml-8 text-center md:text-left w-full md:w-auto relative h-40 sm:h-48 md:h-32">
                ...
                >
                  ...
                  {`Class ${formData.std || 'X'} - ${formData.stream || 'Science'}`}
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, x: -20 }}
                  animate={{ opacity: 1, x: 0 }}
  ...
  >
    ...
    <div className="relative">
      ...
      <input
        ...
        disabled={disabled}
        required={required}
        className={`block w-full rounded-xl bg-gray-50 border border-gray-300 text-gray-700 shadow-sm text-base sm:text-lg p-3 sm:p-4 pl-10 sm:pl-12 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all ${disabled ? 'bg-gray-100 cursor-not-allowed' : ''
          }`}
        {...props}
      />
    </div>
