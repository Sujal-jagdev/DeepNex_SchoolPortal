          ...
          <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
            <div className="relative w-full md:w-64">
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-gray-800"
                value={searchTerm}
            ...
            <div className="flex flex-wrap gap-2 w-full md:w-auto">
              ...
              <button
                ...
                className="px-3 py-2 bg-gray-200 text-black-700 rounded-lg hover:bg-gray-100 focus:outline-none text-gray-800"
              >
                Reset
              </button>
            </div>
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  type="text"
                  className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-gray-800"
                  value={newUser.name}
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1 text-gray-800">Role</label>
                <select
                  className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-gray-800"
                  value={newUser.role}
