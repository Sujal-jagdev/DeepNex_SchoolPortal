      ...
      <div className="bg-blue-600 bg-opacity-95 text-white">
        <div className="max-w-7xl mx-auto px-4 py-4 md:py-6 flex justify-between items-center">
          <div className="flex items-center space-x-3">
            {/* Mobile menu button */}
            <button 
              className="md:hidden p-2 ml-[25px] rounded-md hover:bg-blue-700 transition-colors"
      ...
      <div className="flex-grow flex overflow-hidden relative">
        ...
        >
          ...
          <div className="space-y-4 mt-8 md:mt-0">
            ...
            {/* Removed AI Assistant info card */}
          </div>
        </div>
              ...
              <form onSubmit={handleSendMessage} className="flex items-center space-x-2 w-full">
                <div className="relative flex-grow">
                  <textarea
                    ...
                    className="w-full px-3 py-2 md:px-4 md:py-3 pr-10 md:pr-12 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-all resize-none min-h-[40px] md:min-h-[50px] max-h-[100px] md:max-h-[120px] overflow-auto text-base"
                    rows="1"
                    onKeyDown={(e) => {
