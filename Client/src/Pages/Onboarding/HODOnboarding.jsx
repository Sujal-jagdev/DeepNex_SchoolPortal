...
const HODOnboarding = () => {
  ...
  useEffect(() => {
    const checkAuth = async () => {
      try {
        ...
        // Check if user already has a completed HOD profile
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const requiredFields = ['fullname', 'phone', 'department', 'highest_qualification', 'department_vision'];
      ...
      const { error } = await supabase
        ...
        .upsert({
          ...
          bio: formData.bio,
          department_vision: formData.department_vision,
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-md overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-purple-500 to-purple-700 px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-xl font-bold text-white">Department Head Onboarding</h1>
            </div>
            <div className="flex items-center space-x-1 text-purple-100">
              ...
              <span className={`font-medium ${currentStep >= 2 ? 'text-white' : ''}`}>Department</span>
              <ArrowRight className="h-4 w-4" />
        ...
        <div className="w-full bg-gray-200 h-1">
          <div 
            className="bg-purple-500 h-1 transition-all duration-300 ease-in-out" 
            ...
            >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full pl-10 px-4 py-2 border border-gray-300 rounded-md focus:ring-purple-500 focus:border-purple-500"
                      required
                    />
                  </div>
                </div>
              ...
              <div className="flex justify-end">
                <button
                  type="button"
                  onClick={nextStep}
                  className="px-6 py-2 bg-purple-600 text-white rounded-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 flex items-center"
                >
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                  <label htmlFor="department_vision" className="block text-sm font-medium text-gray-700 mb-1">
                    Department Vision <span className="text-red-500">*</span>
                  </label>
                  <textarea
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    rows="4"
                    className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-purple-500 focus:border-purple-500"
                    placeholder="Tell us about your professional background and leadership philosophy..."
                  ></textarea>
                </div>
              </div>
              ...
              <div className="flex justify-between">
                <button
                  type="button"
                  onClick={prevStep}
                  className="px-6 py-2 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
                >
                  Back
                </button>
                <button
          ...
          {currentStep === 3 && (
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <h3 className="font-medium text-gray-900 border-b pb-2">Department Information</h3>
                  ...
                  <div>
                    ...
                    <p className="font-medium">{formData.specialization || 'Not provided'}</p>
                  </div>
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="mt-4">
                    <p className="text-sm text-gray-500">Department Vision</p>
                    <p className="font-medium">{formData.department_vision || 'Not provided'}</p>
                  </div>
