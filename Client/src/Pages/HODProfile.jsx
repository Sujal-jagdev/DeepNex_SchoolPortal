    ...
    try {
      ...
      if (tempProfileImage && tempProfileImage !== profileImage) {
        ...
        if (file) {
          ...
          if (profileImage && profileImage.includes('hod-images')) {
            try {
              const oldImagePath = profileImage.split('hod-images/')[1];
              if (oldImagePath) {
          ...
          const filePath = `hod-images/${fileName}`;
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        >
          ...
          <div className="relative h-32 sm:h-40 md:h-48 bg-gradient-to-r from-indigo-500 to-purple-600">
            ...
            {/* Edit/Save button with loading state */}
            <motion.button
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start -mt-16 sm:-mt-20 md:-mt-24">
              ...
              <div className="mt-4 md:mt-0 md:ml-6 lg:ml-8 text-center md:text-left w-full md:w-auto relative h-40 sm:h-48 md:h-32">
                ...
                >
                  ...
                  {formData.department_expertise || 'Department Head'}
                </motion.div>
                <motion.div 
                  initial={{ opacity: 0, x: -20 }}
                  animate={{ opacity: 1, x: 0 }}
                ...
                >
                  ...
                  >
                    ...
                    <div className="space-y-3 sm:space-y-4">
                      <ProfileInfoItem 
                        ...
                        value={formData.department_expertise || 'Not specified'} 
                      />
                      <ProfileInfoItem 
                  ...
                  >
                    ...
                    <div className="text-gray-700">
                      {formData.vision_department || 'No vision statement provided yet.'}
                    </div>
                  </motion.div>
                </motion.div>
              ) : (
                ...
                >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleInputChange}
                      rows="4"
                      className="block w-full rounded-xl bg-gray-50 border border-gray-300 text-gray-700 shadow-sm text-base sm:text-lg p-3 sm:p-4 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all placeholder-gray-400 disabled:opacity-70"
                  ...
                  <div className="flex justify-end gap-4">
                    <motion.button
                      ...
                      whileHover={{ scale: isSaving ? 1 : 1.05 }}
                      whileTap={{ scale: isSaving ? 1 : 0.95 }}
                      className="flex items-center gap-2 px-6 py-2.5 sm:px-8 sm:py-3 bg-gray-200 text-gray-700 rounded-xl hover:bg-gray-300 transition-all shadow hover:shadow-md text-base sm:text-lg font-medium disabled:opacity-70 disabled:cursor-not-allowed"
                    >
                      <X size={16} className="sm:w-4 sm:h-4" />
                      <span>Cancel</span>
                    </motion.button>
...
// Enhanced reusable components with disabled state
...
const InputField = ({ label, name, value, onChange, icon, type = "text", placeholder = "", required = false, disabled = false }) => (
  <div>
    <label className="block text-base sm:text-lg font-medium text-gray-700 mb-2 flex items-center gap-2">
      {icon}
      <span>{label}</span>
...
const SelectField = ({ label, name, value, onChange, options, icon, disabled = false }) => (
  <div>
    <label className="block text-base sm:text-lg font-medium text-gray-700 mb-2 flex items-center gap-2">
      {icon}
      <span>{label}</span>
